...
const snapResolver = require('./snapResolver');
async function getLinks(baseurl, initialImagesPath, comparedImagesPath) {
  ...
  const extractLinks = async (url) => {
    ...
    await snapResolver.resolveSnap(url, initialImagesPath, comparedImagesPath);
